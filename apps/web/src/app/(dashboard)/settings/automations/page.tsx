...
import { Settings, Users, Shield, ScrollText, Bell, Zap, Server, X, Plus, Play, Pause, Trash2, Copy } from 'lucide-react';
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
                ...
                <Button size="sm" onClick={() => { setEditRule(null); setForm({ name: '', event: 'cnh_expiring', conditions: '{"days_before": 30}', actions: [{ type: 'notification', title: '', message: '' }], frequency: 'daily', active: true }); setShowModal(true); }}
