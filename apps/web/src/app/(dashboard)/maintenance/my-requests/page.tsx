...
import { ClipboardList, CheckCircle, Clock, AlertTriangle, MessageSquare, Send, Search, Filter } from 'lucide-react';
            ...
            <div className="flex items-center gap-4 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        className="px-3 py-2 bg-black/30 border border-white/10 rounded-md text-white text-sm focus:outline-none focus:ring-[#00E5FF] focus:border-[#00E5FF]"
                    >
                            ...
                            <div className="flex items-start justify-between gap-4">
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-3 mb-2 flex-wrap">
                                        ...
                                        <span className="px-2 py-0.5 rounded-full text-[10px] font-medium border bg-slate-500/20 text-slate-400 border-slate-500/30">
                                            {getTypeLabel(os.type)}
                                        </span>
                                        {os.priority === 'urgente' && (
                                            <span className="px-2 py-0.5 rounded-full text-[10px] font-bold border bg-red-500/20 text-red-400 border-red-500/30 animate-pulse">
                                                URGENTE
                                            </span>
                                        )}
                                    </div>
            ...
            <Modal isOpen={commentModalOpen} onClose={() => setCommentModalOpen(false)} title={`Timeline — OS-${String(selectedOS?.os_number || '?').padStart(4, '0')}`} size="lg">
                <div className="flex flex-col h-[400px]">
                    ...
                    <div className="border-t border-white/10 pt-3 flex gap-2">
                        <Input
                            placeholder="Escreva uma mensagem ou solicite informação..."
                            value={newComment}
